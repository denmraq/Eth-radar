...
def current_price_levels(price: float, side: str, fwd: dict, atr15: float):
    ...
    TP is intentionally derived from the current 1-hour forward distribution and
    current volatility only. The 6h/12h forecast decides direction for those
    horizons, but it never stretches the active scalp ladder.
    """
